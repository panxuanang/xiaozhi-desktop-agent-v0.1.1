...
Invoke-Checked -FilePath $Python -ArgumentList @(
    '-c',
    "import requests, PIL, qrcode, Crypto, openpyxl, docx, pptx, pandas, matplotlib, psutil, deepseek_harness; import win32crypt, win32com.client; from xiaozhi_agent.runtime import XiaoZhiRuntime; print('RUNTIME_IMPORTS_OK')"
